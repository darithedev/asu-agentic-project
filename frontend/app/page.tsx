...
export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-blue-50/50 to-white p-2 sm:p-4 md:p-6 relative overflow-hidden">
      {/* Subtle cloud-like shapes for depth */}
      ...
      <div className="w-full h-full animate-in fade-in duration-500 relative z-10">
        <ChatInterface />
      </div>
    </div>
  );
